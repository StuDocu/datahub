  ...
  create  table
    "production"."intermediate"."int_product__degree_random_courses__dbt_tmp"
  ...
  as (
    WITH random_courses AS (
     select 
        ...
        ROW_NUMBER() OVER (PARTITION BY coalesce(course.degree_id, degree.id) ORDER BY RANDOM()) as course_rank
    from
