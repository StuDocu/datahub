  ...
  create  table
    "production"."intermediate"."int_product__degree_recent_documents__dbt_tmp"
  ...
  as (
    ...
    select 
        ...
        ROW_NUMBER() OVER (PARTITION BY coalesce(course.degree_id, degree.id) ORDER BY document.published_at DESC) as document_rank
    from
