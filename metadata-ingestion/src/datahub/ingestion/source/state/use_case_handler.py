...
class StatefulIngestionUsecaseHandlerBase(ABC, Generic[StateType]):
    ...
    # TODO: Consider generalizing other state management workflows such as (1) state update
    # and (2) other state based workflows such as stale-entity removal & redundant run skip etc
    # across use-cases.
